    ...
    <>
          ...
          <section className="micro-conversion-section" id="check">
            ...
            <div className="orbital-universe-bg">
              ...
              <div className="orbital-node node-pos-2" title="Regulated Businesses & Fintech">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="2" y="5" width="20" height="14" rx="2" /><path d="M2 10h20M7 15h2" /></svg>
              </div>
              <div className="orbital-node node-pos-3" title="Healthcare & Hospitals">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M12 6v12M6 12h12" /><rect x="3" y="3" width="18" height="18" rx="2" /></svg>
              </div>
              <div className="orbital-node node-pos-4" title="Banking & Insurance">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M3 21h18M3 10h18M5 6l7-3 7 3M4 10v11M20 10v11M8 14v4M12 14v4M16 14v4" /></svg>
              </div>
              <div className="orbital-node node-pos-5" title="Telecoms & MDAs">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M5 12.55a11 11 0 0 1 14.08 0M1.42 9a16 16 0 0 1 21.16 0M8.53 16.11a6 6 0 0 1 6.95 0M12 20h.01" /></svg>
              </div>
              <div className="orbital-node node-pos-6" title="Licensed DPCO Protection">
